...
<input class="btn btn-primary" class="form-control" type="submit" name="submit" value="Submit">
    ...
    <div class="col-sm-8 text-left" style="border: 2px solid black"> 
     ...
     <form id="myForm" action="AdminUpdateParentAndStudent.php" method="POST">
     <div class="col-sm-5 text-left" >
	 <div class="form-group">
     
  <input type="text" value="<?php echo $student_id;?>" name="student_id" hidden="">
  <input type="text" value="<?php echo $parent_id;?>" name="parent_id" hidden="">
  ...
  Class:<input type="text" name="class" class="form-control"  value=<?php echo "$class";?> ></div>
  <div class="form-group">
